...
function normalizeHebrewMonth(input, isLeapYear = false) {
  ...
  const map = {
    ...
    'אדרב': isLeapYear ? months.ADAR_II : months.ADAR_I, 'אדר2': isLeapYear ? months.ADAR_II : months.ADAR_I, 'adarii': isLeapYear ? months.ADAR_II : months.ADAR_I, 'adar2': isLeapYear ? months.ADAR_II : months.ADAR_I,
    'אדר': isLeapYear ? months.ADAR_II : months.ADAR_I,
    'adar': isLeapYear ? months.ADAR_II : months.ADAR_I
  };

  const res = map[str] || months.TISHREI;
  if (!isLeapYear && res === months.ADAR_II) {
